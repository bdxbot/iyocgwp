...
words = {
'Colors': 'red blue yellow purple green orange brown black white'.split(),
'Shapes': 'triangle square rectangle circle ellipse diamond rhombus trapezoid \
pentagon hexagon septagon octagon decagon'.split(),
'Fruits': 'apple orange lemon lime pear watermelon grape grapefruit cherry \
banana cantaloupe mango strawberry plum tomato'.split(),
'Animals': 'ant baboon badger bat bear beaver camel cat calm cobra cougar coyote \
...
def getRandomWordDict(wordDict):
...
secretWord, secretSet = getRandomWordDict(words)
#!secretWord = 'apple'
gameIsDone = False
