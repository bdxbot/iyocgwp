...
def chooseCave():
	# create a local variable called 'cave' and assign an empty string to it
	cave = ''
...
# create a function called checkCave that takes a parameter of choseCave
def checkCave(chosenCave):
	...
	# create a local variable called friendlyCave and assign it a random number 
	# between 1 and 2
...
# create a global variable called playAgain and assign it the string 'yes'
playAgain = 'yes'
...
while playAgain == 'yes' or playAgain == 'y':
	...
	displayIntro()
	# create a local variable called caveNumber, call the choseCave() function, 
	# which will ask the player to chose a cave and return the players answer, 
	# which will get assigned to the caveNumber variable
	caveNumber = chooseCave()
	# call the checkCave function and feed it the value of caveNumber as a parameter
	checkCave(caveNumber)

	# print some text
	print('Do you want to play again (yes or no)?: ')
	# ask the players input and assign it to the playAgain local variable, which will
